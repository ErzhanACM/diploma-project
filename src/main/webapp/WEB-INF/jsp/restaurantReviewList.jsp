    ...
    <c:if test="${not empty reviews}">
        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <h2 class="font-weight-light text-center text-lg-left mt-4 mb-0"><spring:message code="reviews" /></h2>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><spring:message code="mark" />: ${review.rating}/10</h5>
