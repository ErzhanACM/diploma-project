...
<div class="container px-4 pt-4">
    ...
    <div class="row justify-content-center mt-4">
        <h4 class="page-title"><spring:message code="page.title.editing.restaurant"/></h4>
    </div>

    <div class="row justify-content-center mt-2">
        <p><spring:message code="headline.restaurant.editing.rule"/></p>
    </div>
    ...
    <form:form method="post" action="/restaurant/updateRestaurant" class="needs-validation" novalidate="true">
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input class="form-control <c:if test="${not empty nameError}">is-invalid</c:if>" type="text"
                       ...
                       value="<c:if test="${not empty restaurant}">${restaurant.name}</c:if>"
        ...
        <div class="form-row">
            <div class="col-md-2 mb-3">
                ...
                <select class="form-control <c:if test="${not empty cityError}">is-invalid</c:if>" name="city"
                        id="restaurantCity">
                    <c:if test="${not empty restaurant.city}">
                        <option value="${restaurant.city}" selected><spring:message
                                code="${restaurant.city}"/></option>
                    </c:if>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control <c:if test="${not empty addressError}">is-invalid</c:if>" type="text"
                       ...
                       value="<c:if test="${not empty restaurant}">${restaurant.address}</c:if>"
        ...
        <div class="form-row">
            <div class="col-md-3 mb-3">
                ...
                <input class="form-control <c:if test="${not empty capacityError}">is-invalid</c:if>"
                       ...
                       value="<c:if test="${not empty restaurant}">${restaurant.capacity}</c:if>"
            ...
            <div class="col-md-3 mb-3">
                ...
                <input class="form-control <c:if test="${not empty pricePerPersonError}">is-invalid</c:if>"
                       ...
                       value="<c:if test="${not empty restaurant}">${restaurant.pricePerPerson}</c:if>"
                       required>
                <div class="invalid-feedback">
        ...
        <div class="form-row">
            ...
            <div class="col-md-8 mb-3">
                ...
                <textarea class="form-control <c:if test="${not empty descriptionError}">is-invalid</c:if>"
                        ...
                        test="${not empty restaurant}">${restaurant.description}</c:if></textarea>
                <div class="invalid-feedback">
        ...
        <div class="row justify-content-center">
            <button class="btn mt-3 px-5 custom-btn dark-btn " type="submit"><spring:message
                    code="button.edit.restaurant"/></button>
        </div>
    </form:form>
